...
func applyStyle() {
    ...
    UITextView.appearance().tintColor = Colors.blue
    UITextField.appearance().tintColor = Colors.blue
    UIImageView.appearance().tintColor = Colors.lightBlue
    
    UITabBarItem.appearance().setTitleTextAttributes([.foregroundColor: Colors.blue], for: .selected)
...
struct StyleLayout {
    ...
    struct TableView {
        ...
        static let separatorColor = Colors.tableSeparator
    }
}
