...
class TokenObject: Object, Decodable {
    ...
    @objc dynamic var lovercaseContract: String = ""
    ...
    convenience init(
        ...
        self.lovercaseContract = contract.lowercased()
        self.name = name
    ...
    override func isEqual(_ object: Any?) -> Bool {
        ...
        return object.contract.caseInsensitiveCompare(self.contract) == .orderedSame
    }
